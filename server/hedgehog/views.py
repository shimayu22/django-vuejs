...
from .serializer import UserSerializer, PileColorSerializer, HedgeHogSerializer, CommentSerializer
...
class UserRetrieveUpdate(generics.RetrieveUpdateAPIView):
  ...
  Accepts GET and PUT requests and the record id must be provided in the requests """
  queryset = User.objects.all()
  serializer_class = UserSerializer
  permission_classes = (permissions.IsAuthenticated,)

class PileColorListCreate(generics.ListCreateAPIView):
  """ List and create PileColor """
...
class PileColorRetrieveUpdate(generics.RetrieveUpdateAPIView):
  """ Retrive and update PileColor infomation """
  queryset = PileColor.objects.all()
  serializer_class = PileColorSerializer
  permission_classes = (permissions.IsAuthenticated,)
